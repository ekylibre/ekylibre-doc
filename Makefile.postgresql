...
BASEDIR := $(HOME)/ekylibre-$(VERSION)-fr
HTM_OUTPUT := ekylibre-$(VER)-fr
...
OUTPUT_DIR := $(shell pwd)/ekylibre
GNOME_DIR := $(OUTPUT_DIR)/gnome
XHTML_DIR := $(OUTPUT_DIR)/xhtml
XHTML11_DIR := $(OUTPUT_DIR)/xhtml-1_1

# all: html webhtml pdf manpages INSTALL.html INSTALL.txt
all: clean xhtml xhtml11 gnome
...
xhtml11:
	mkdir -p $(XHTML11_DIR)
	xsltproc --xinclude --nonet -o $(XHTML11_DIR) /usr/share/xml/docbook/stylesheet/docbook-xsl/xhtml-1_1/chunk.xsl ekylibre.xml 
...
xhtml:
	...
	xsltproc --xinclude --nonet --stringparam profile.condition html \
		...
		--stringparam base.dir $(XHTML_DIR)/ \
		 /usr/share/xml/docbook/stylesheet/docbook-xsl/xhtml/chunk.xsl ekylibre.xml 

gnome: 
	mkdir -p $(GNOME_DIR)
	xsltproc --xinclude --nonet -o $(GNOME_DIR)/ekylibre.xhtml /usr/share/xml/gnome/xslt/docbook/html/db2xhtml.xsl ekylibre.xml


# /usr/share/xml/docbook/stylesheet/docbook-xsl/xhtml/docbook.xsl
# /usr/share/xml/gnome/xslt/docbook/html/db2xhtml.xsl
# --stringparam use.id.as.filename "yes"  --stringparam profile.condition html --stringparam  profile.attribute  "standalone" --stringparam  profile.value  "no"
...
index.html: $(src)
	...
	xsltproc --xinclude --nonet -stringparam profile.condition html \
		...
		stylesheets/pg-chunked.xsl ekylibre.xml
